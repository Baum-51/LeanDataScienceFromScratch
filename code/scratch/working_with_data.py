...
plt.savefig('../picture/working_scatter.png')
plt.gca().clear()
...
def main():
    ...
    plt.savefig('../picture/working_histogram_uniform.png')
    plt.gca().clear()
    plt.close()
    ...
    plt.savefig('../picture/working_histogram_normal.png')
    plt.gca().clear()
    ...
    plt.savefig('../picture/working_scatterplot_matrix.png')
    plt.gca().clear()
    plt.close()
    plt.clf()
